...
@Database(entities = [CaseSummaryVO::class,CheckOutVO::class,ConsultationRequestVO::class,ConsultationsVO::class,DoctorVO::class,GeneralQuestionsVO::class,
    LiveChatVO::class,MedicinesVO::class,PatientVO::class,PrescriptionVO::class,SpecialitiesVO::class,SpecialityQuestionsVO::class,MedicalHistoryVO::class],version = 28,exportSchema = false)
